...
const DeveloperSettings = () => {
  ...
  const handleEdit = () => {
    // Trigger your edit logic here, e.g., open dialog with selectedMachine
    console.log("Edit clicked for", selectedMachine);
    handleMenuClose();
  };

  const handleDelete = () => {
    // Trigger your delete logic here
    console.log("Delete clicked for", selectedMachine);
    handleMenuClose();
  };
